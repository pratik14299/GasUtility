...
from .serializer import CustomerSerializer, ServiceRequestSerializer,TrackStatusSerializer
    ...
    def get(self, request, tracking_no):
        try:
            ...
            if track_statuses:
                ...
                resolved_date = service_request.resolved_at.strftime("%Y-%m-%d %H:%M:%S") if service_request.resolved_at else "Not resolved yet"
                return Response({"tracking_no": str(tracking_no), "statuses": status_list,"resolved_date":resolved_date})
            else:
